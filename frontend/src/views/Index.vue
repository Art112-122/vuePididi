...
<template>
    ...
    <div class="grid">
      ...
      <div class="cell is-col-start-8">
        <a class="icon-text pt-5">
          ...
          <span class="purple-text title is-5">Вхід</span>
        </a>
      </div>
      <div class="cell is-col-start-9">
        <a class="icon-text pt-5" href="http://localhost:8080/#/register">
          ...
          <span class="purple-text title is-5">Регестрація</span>
        </a>
      </div>
    </div>
  </div>
  ...
  <div class="fixed-grid has-10-cols dark-background pt-5">
    <div class="grid">

      <div class="cell is-col-start-3">
        <div class="box card-anim" style="width: 28rem">
          <div style="text-align: start; font-size: 2rem">ПВБ Банк</div>
          <div style="text-align: center; font-size: 3rem" class="py-6">1111 2222 3333 4444
          </div>
          <div style="font-size: 1rem">User1</div>
        </div>
        <h2 class="subtitle is-4" style="text-align: center; font-family: fantasy">Картка на любий смак</h2>
        <div style="text-align: center">Увага! Валюта ПБ виртуальна! За ПБ можно
          тільки купити внутри-сайтові бонуси
        </div>
        ...
        <div class="subtitle is-6 pt-3" style="text-align: center">Да.</div>
      ...
      <div class="cell is-col-start-7">
        ...
        <div class="subtitle is-3" style="text-align: center; font-family: fantasy">Великий Кешбек!</div>
        <div class="subtitle is-6" style="text-align: center">Може?..</div>
        ...
        <div class="subtitle is-4" style="text-align: center; font-family: fantasy">Щоденні перекази!</div>
        <div class="subtitle is-6" style="text-align: center">Без вашего підтверження!</div>
      </div>
